...
- [ ] Pick this type (TYPE-003) — confirm it's the right fit, or identify hybrid types to borrow from
...
## Alignment checklist (existing repo → TYPE-003)
...
- [ ] Add `docs/repo-type.md` pointing to TYPE-003
