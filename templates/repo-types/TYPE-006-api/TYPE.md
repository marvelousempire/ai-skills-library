...
- [ ] Pick this type (TYPE-006) — confirm it's the right fit, or identify hybrid types to borrow from
...
## Alignment checklist (existing repo → TYPE-006)
...
- [ ] Add `docs/repo-type.md` pointing to TYPE-006
