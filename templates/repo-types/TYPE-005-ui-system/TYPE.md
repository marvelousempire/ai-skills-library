...
- [ ] Pick this type (TYPE-005-ui) — confirm it's the right fit, or identify hybrid types to borrow from
...
## Alignment checklist (existing repo → TYPE-005-ui)
...
- [ ] Add `docs/repo-type.md` pointing to TYPE-005-ui
