...
- [ ] Pick this type (TYPE-002) — confirm it's the right fit, or identify hybrid types to borrow from
...
## Alignment checklist (existing repo → TYPE-002)
...
- [ ] Add `docs/repo-type.md` pointing to TYPE-002
