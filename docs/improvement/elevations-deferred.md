...
- [skills-library] **G. ~~`scripts/cleanup-ruflo.sh`~~ — RESOLVED 2026-05-14**: ruflo plugins are nephew's engine for the native swarm; integrated via `rules/library/plugin-economy/body.md` + `agents/nephew.md` §My infrastructure + `docs/standards/orchestration-hierarchy.md` §Engine note. (audit: docs/improvement/audits/2026-05-14-brokerage-make-shim-docker-colima.md)
