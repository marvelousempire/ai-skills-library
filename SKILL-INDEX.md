...
- **178** total `SKILL.md` files under [`skills/`](skills/) (each with `skill.plugin.json` + `skill.plugin.md`).
...
| **metadata-post-or-product-mode** | Cursor + Claude | [`skills/methodology/metadata-post-or-product-mode/`](skills/methodology/metadata-post-or-product-mode/) | Choose Post (workspace post-meta.json) vs Product (catalog/plugin card) before writing skill, agent, rule, or Tower metadata | "Use **metadata-post-or-product-mode**." | create-skill, add-agent-to-skills-library |
