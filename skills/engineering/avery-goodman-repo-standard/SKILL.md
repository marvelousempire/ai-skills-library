...
description: >-
  The branded GitHub repo schema for every project under AVERY GOODMAN.
  Defines the one-word label system for every folder and README section,
  the brand mark format ("App Name — managed by the duty and order of AVERY
  GOODMAN"), the exact README blueprint with examples of what each labeled
  section contains, and the recognizable structure that makes every repo
  immediately identifiable as part of the AVERY GOODMAN portfolio. Triggers
  on "set up this repo the AVERY GOODMAN way", "brand this repo", "apply the
  repo standard", "create the README", "how should our repos look",
  "AVERY GOODMAN repo template", "repo schema", "brand mark", "portfolio repos".
---
