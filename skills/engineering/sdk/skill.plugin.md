...
Artifact type:     skill
Skill ID:          SK-0041
Summary:           Guide users building apps, scripts, CI pipelines, or automations on top of the Cursor TypeScript SDK (`@cursor/sdk`). Use when the user mentions integrating,…
...
| **Type** | skill |
| **Skill ID** | SK-0041 |
| **Path** | `skills/engineering/sdk` |

## Summary

Guide users building apps, scripts, CI pipelines, or automations on top of the Cursor TypeScript SDK (`@cursor/sdk`). Use when the user mentions integrating,…
...
`build-sdk`, `integrate-api`, `configure-client`
