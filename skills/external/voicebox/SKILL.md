...
| | |
|--|--|
| **Upstream** | [jamiepine/voicebox](https://github.com/jamiepine/voicebox) |
...
- **Artifact:** `jamiepine/voicebox` is the real product repository.
- **Bridge:** `skills/external/voicebox/SKILL.md` is the agent playbook.
