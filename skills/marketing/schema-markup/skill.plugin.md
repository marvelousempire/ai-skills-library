...
skill_slug: schema-markup
generated_at: 2026-05-19T19:05:57Z
---

<!--
Skill Name:       Schema Markup
Slug:              schema-markup
...
Artifact type:     skill
Skill ID:          SK-0101
Summary:           When the user wants to add, fix, or optimize schema markup and structured data on their site. Also use when the user mentions "schema markup," "structured…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **schema-markup**.
-->
...
`write-schema`, `check-markup`, `file-schema`
