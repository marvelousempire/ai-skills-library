...
Artifact type:     skill
Skill ID:          SK-0097
Summary:           When the user wants to create SEO-driven pages at scale using templates and data. Also use when the user mentions "programmatic SEO," "template pages," "pages…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **programmatic-seo**.
-->
...
`write-programmatic`, `check-seo`, `file-programmatic`
