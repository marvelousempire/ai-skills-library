...
Artifact type:     skill
Skill ID:          SK-0071
Summary:           Write B2B cold emails and follow-up sequences that get replies. Use when the user wants to write cold outreach emails, prospecting emails, cold email…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **cold-email**.
-->
...
Write B2B cold emails and follow-up sequences that get replies. Use when the user wants to write cold outreach emails, prospecting emails, cold email…
...
`write-cold`, `check-email`, `file-cold`
