...
skill_slug: launch-strategy
generated_at: 2026-05-21T08:11:23Z
---

<!--
Skill Name:       Launch Strategy
...
Artifact type:     skill
Skill ID:          SK-0086
Summary:           When the user wants to plan a product launch, feature announcement, or release strategy. Also use when the user mentions 'launch,' 'Product Hunt,' 'feature…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **launch-strategy**.
-->
...
When the user wants to plan a product launch, feature announcement, or release strategy. Also use when the user mentions 'launch,' 'Product Hunt,' 'feature…
...
`write-launch`, `check-strategy`, `file-launch`
