...
skill_slug: email-sequence
generated_at: 2026-05-21T08:11:23Z
---

<!--
Skill Name:       Email Sequence
Slug:              email-sequence
...
Artifact type:     skill
Skill ID:          SK-0081
Summary:           When the user wants to create or optimize an email sequence, drip campaign, automated email flow, or lifecycle email program. Also use when the user mentions…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **email-sequence**.
-->
...
`write-email`, `check-sequence`, `file-email`
