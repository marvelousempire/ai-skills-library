...
skill_slug: signup-flow-cro
generated_at: 2026-05-21T08:11:23Z
---

<!--
Skill Name:       Signup Flow Cro
...
Artifact type:     skill
Skill ID:          SK-0103
Summary:           When the user wants to optimize signup, registration, account creation, or trial activation flows. Also use when the user mentions "signup conversions,"…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **signup-flow-cro**.
-->
...
`write-signup`, `check-flow`, `build-cro`
