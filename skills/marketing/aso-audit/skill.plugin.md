...
skill_slug: aso-audit
generated_at: 2026-05-21T08:11:23Z
---

<!--
Skill Name:       Aso Audit
Slug:              aso-audit
...
Artifact type:     skill
Skill ID:          SK-0068
Summary:           When the user wants to audit or optimize an App Store or Google Play listing. Also use when the user mentions 'ASO audit,' 'app store optimization,' 'optimize…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **aso-audit**.
-->
...
| **Type** | skill |
| **Skill ID** | SK-0068 |
| **Path** | `skills/marketing/aso-audit` |
...
`write-aso`, `check-audit`, `file-aso`
