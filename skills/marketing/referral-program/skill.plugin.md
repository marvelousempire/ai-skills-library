...
skill_slug: referral-program
generated_at: 2026-05-21T08:11:23Z
---

<!--
Skill Name:       Referral Program
...
Artifact type:     skill
Skill ID:          SK-0098
Summary:           When the user wants to create, optimize, or analyze a referral program, affiliate program, or word-of-mouth strategy. Also use when the user mentions…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **referral-program**.
-->
...
`write-referral`, `check-program`, `file-referral`
