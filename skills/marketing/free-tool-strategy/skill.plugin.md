...
skill_slug: free-tool-strategy
generated_at: 2026-05-19T19:05:57Z
---

<!--
Skill Name:       Free Tool Strategy
...
Artifact type:     skill
Skill ID:          SK-0084
Summary:           When the user wants to plan, evaluate, or build a free tool for marketing purposes — lead generation, SEO value, or brand awareness. Also use when the user…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **free-tool-strategy**.
-->
...
`write-free`, `check-tool`, `build-strategy`
