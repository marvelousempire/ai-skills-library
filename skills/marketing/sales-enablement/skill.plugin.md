...
Artifact type:     skill
Skill ID:          SK-0100
Summary:           When the user wants to create sales collateral, pitch decks, one-pagers, objection handling docs, or demo scripts. Also use when the user mentions 'sales…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **sales-enablement**.
-->
...
When the user wants to create sales collateral, pitch decks, one-pagers, objection handling docs, or demo scripts. Also use when the user mentions 'sales…
...
`write-sales`, `check-enablement`, `file-sales`
