...
skill_slug: community-marketing
...
Artifact type:     skill
Skill ID:          SK-0072
Summary:           Build and leverage online communities to drive product growth and brand loyalty. Use when the user wants to create a community strategy, grow a Discord or…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **community-marketing**.
-->
...
`write-community`, `check-marketing`, `file-community`
