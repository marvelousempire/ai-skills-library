...
Artifact type:     skill
Skill ID:          SK-0079
Summary:           When the user wants to conduct, analyze, or synthesize customer research. Use when the user mentions "customer research," "ICP research," "talk to customers,"…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **customer-research**.
-->
...
`write-customer`, `check-research`, `file-customer`
