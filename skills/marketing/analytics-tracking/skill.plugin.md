...
skill_slug: analytics-tracking
generated_at: 2026-05-19T19:05:57Z
---

<!--
Skill Name:       Analytics Tracking
...
Artifact type:     skill
Skill ID:          SK-0067
Summary:           When the user wants to set up, improve, or audit analytics tracking and measurement. Also use when the user mentions "set up tracking," "GA4," "Google…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **analytics-tracking**.
-->
...
`write-analytics`, `check-tracking`, `file-analytics`
