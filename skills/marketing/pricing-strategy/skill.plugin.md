...
skill_slug: pricing-strategy
generated_at: 2026-05-21T08:11:23Z
---

<!--
Skill Name:       Pricing Strategy
...
Artifact type:     skill
Skill ID:          SK-0095
Summary:           When the user wants help with pricing decisions, packaging, or monetization strategy. Also use when the user mentions 'pricing,' 'pricing tiers,' 'freemium,'…
Author:            marvelousempire
License:           MIT
Requires:          —
Invoke:            Use **pricing-strategy**.
-->
...
`write-pricing`, `check-strategy`, `file-pricing`
