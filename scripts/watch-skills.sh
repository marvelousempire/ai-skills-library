...
run_validate() {
  ...
  python3 "${ROOT}/scripts/generate-agent-plugin-manifests.py"
  python3 "${ROOT}/scripts/generate-library-plugin-catalog.py"
  python3 "${ROOT}/scripts/validate-skill-frontmatter.py"
  python3 "${ROOT}/scripts/validate-skill-plugin-manifests.py"
  python3 "${ROOT}/scripts/validate-agent-plugin-manifests.py"
}
